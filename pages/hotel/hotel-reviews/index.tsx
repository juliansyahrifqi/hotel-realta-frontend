...
const HotelReviews = () => {
  let { hore, message, refresh } = useSelector(
    (state: any) => state.hotelReviewsReducers
  )
  ...
  useEffect(() => {
    dispatch(doRequestGetHotelReviews())
  }, [refresh])
  return (
    <div>
      <Header>
