import { doAddWorkOrderDetail } from "@/redux/human_resources/action/workOrderDetailActionReducer";
import { Dialog, Transition } from "@headlessui/react";
import { Fragment } from "react";
import { useForm } from "react-hook-form";
import { useDispatch } from "react-redux";

export default function CreateOrderDetail(props: any) {
  type FormValues = {
    seta_name: string;
  ...
  const handleRegistration = async (data: any) => {
    ...
    dispatch(doAddWorkOrderDetail(DataForm));
    props.closeModal();
  };
  ...
  const registerOptions = {
    seta_name: { required: "masukan tugas" },
    user_full_name: { required: "masukan nama" },
    wode_status: { required: "masukan status" },
    wode_notes: { required: "masukan catatan" },
  };
